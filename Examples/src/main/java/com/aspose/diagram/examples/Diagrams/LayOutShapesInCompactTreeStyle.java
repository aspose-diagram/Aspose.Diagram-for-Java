...
public class LayOutShapesInCompactTreeStyle {
	...
	public static void main(String[] args) throws Exception {
		...
		String dataDir = Utils.getSharedDataDir(LayOutShapesInCompactTreeStyle.class) + "Diagrams/";
		...
		diagram.layout(compactTreeOptions);
		diagram.save(dataDir + "LayOutShapesInCompactTreeStyle-out.vdx", SaveFileFormat.VDX);
	}
