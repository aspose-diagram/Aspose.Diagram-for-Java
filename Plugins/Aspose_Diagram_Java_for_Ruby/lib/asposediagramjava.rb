require_relative 'asposediagramjava/version'
require_relative 'asposediagramjava/asposediagram'
require 'logger'
require 'rjb'
...
module Asposediagramjava
  ...
  class << self
    attr_accessor :aspose_diagram_config
  end

  def initialize_aspose_diagram
    aspose_jars_dir = Asposediagramjava.aspose_diagram_config ? Asposediagramjava.aspose_diagram_config['jar_dir'] : nil  
    aspose_license_path = Asposediagramjava.aspose_diagram_config ? Asposediagramjava.aspose_diagram_config['license_path'] : nil
    jvm_args = Asposediagramjava.aspose_diagram_config ? Asposediagramjava.aspose_diagram_config['jvm_args'] : nil
  ...
  def self.configure_aspose_diagram config
    Asposediagramjava.aspose_diagram_config = config
  end
